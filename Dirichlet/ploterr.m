clearvars -except errerr10 errerr20 errerr40 errerr10b errerr20b errerr40b berrerr2 berrerr4 berrerr8 berrerr berrerr4 berrerr8 berrerrnon2 berrerrnon4 berrerrlin2 berrerrlin4 err2b cverr2b err4b
close all
...
% A = [2 2 3; 2 2 4; 2 2 5; 2 2 6; 2 3 3; 2 3 4; 2 3 5 ; 2 3 6; 2 4 3;2 4 4; 2 4 5 ;2 4 6 ;2 5 3 ;2 5 4 ;2 5 5 ; 2 5 6;3 2 4; 3 2 5 ; 3 2 6; 3 3 4; 3 3 5; 3 3 6; 3 4 4 ; 3 4 5; 3 4 6; 3 5 4; 3 5 5; 3 5 6; 
A = [2 2 4;2 2 6;2 4 4;2 4 6; 2 6 4; 2 6 6; 4 2 6; 4 4 6; 4 6 6];
...
%    [err4b(j),x,cverr4b(j),exacterr(:,j),ee(:,j)] = errordriver(N,A(j,1),A(j,2),A(j,3),1/10,100,.1,7,'Advection');
  ...
  [errerr40(j),x,cverr,exacterr(:,j),ee(:,j)] = errordriver(N,A(j,1),A(j,2),A(j,3),1,100,10,7,'Poisson');
