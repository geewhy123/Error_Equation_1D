...
er = errordriver(20,2,4,4,1/3,'D',0,'D',0,0.1,'irk1','Poisson','TimeAccurate')
assert(abs(er-.02736)<1e-4)
...
% these test should pass if revive the error BC in solvebyeulerjacobian:562
