clearvars -except cverr10 cverr20 errerr10 errerr20 errerr40 errerr80 errerr10b errerr20b errerr40b berrerr2 berrerr4 berrerr8 berrerr berrerr4 berrerr8 berrerrnon2 berrerrnon4 berrerrlin2 berrerrlin4 err2b cverr2b err4b
close all
...
%   [errerr80(j),x,cverr,exacterr(:,j),ee(:,j)] = errordriver(N,A(j,1),A(j,2),A(j,3),1/3,'D',0,'D',0,10,7,'Poisson','SS');
  [errerr40(j),x,cverr40(j),exacterr(:,j),ee(:,j)] = errordriver(N,A(j,1),A(j,2),A(j,3),1/3,'D',1-tanh(0),'D',1-tanh(1/2),10,7,'BurgersMod','SS');
