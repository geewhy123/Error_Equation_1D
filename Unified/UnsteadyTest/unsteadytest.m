...
% save('unsteadytestfullprofilesdiffusionimplicitdirichletfineCFLpoint2.mat','errerr','x','cverr','exacterr','ee')
% save('unsteadytestfullprofilesdiffusionimplicitdirichletspapi2.mat','errerr','x','cverr','exacterr','ee')
% save('unsteadytestfullprofilesdiffusionimplicitdirichletpchip.mat','errerr','x','cverr','exacterr','ee')
% error('1')
...
% load('unsteadytestfullprofilesdiffusionimplicitdirichletfineCFLpoint2.mat')
load('unsteadytestfullprofilesdiffusionimplicitdirichletspapi2.mat')
% load('unsteadytestfullprofilesdiffusionimplicitdirichletpchip.mat')
str = ['-*' ;'-o' ;'-^';'-v'];
% for i = 1:5
% subplot(2,3,i)
% for j = 1:3
...
for i = 1:length(p)
    for j = 1:length(q)
       ...
       order(i,j) = log(data(end-1)/data(end))/log(2);
    end 
end
order
