...
syms z
xb1 = (1/h(i+1))*int(z-x(i+1),z,x(i+1)-h(i+1)/2,x(i+1)+h(i+1)/2);
xb2 = (1/h(i+2))*int(z-x(i+2),z,x(i+2)-h(i+2)/2,x(i+2)+h(i+2)/2);
xb3 = (1/h(i+3))*int(z-x(i+3),z,x(i+3)-h(i+3)/2,x(i+3)+h(i+3)/2);
xb4 = (1/h(i+4))*int(z-x(i+4),z,x(i+4)-h(i+4)/2,x(i+4)+h(i+4)/2);
xbi = (1/h(i))*int(z-x(i),z,x(i)-h(i)/2,x(i)+h(i)/2);

x2b1 = (1/h(i+1))*int((z-x(i+1))^2,z,x(i+1)-h(i+1)/2,x(i+1)+h(i+1)/2);
x2b2 = (1/h(i+2))*int((z-x(i+2))^2,z,x(i+2)-h(i+2)/2,x(i+2)+h(i+2)/2);
x2b3 = (1/h(i+3))*int((z-x(i+3))^2,z,x(i+3)-h(i+3)/2,x(i+3)+h(i+3)/2);
x2b4 = (1/h(i+4))*int((z-x(i+4))^2,z,x(i+4)-h(i+4)/2,x(i+4)+h(i+4)/2);
x2bi = (1/h(i))*int((z-x(i))^2,z,x(i)-h(i)/2,x(i)+h(i)/2);

x3b1 = (1/h(i+1))*int((z-x(i+1))^3,z,x(i+1)-h(i+1)/2,x(i+1)+h(i+1)/2);
x3b2 = (1/h(i+2))*int((z-x(i+2))^3,z,x(i+2)-h(i+2)/2,x(i+2)+h(i+2)/2);
x3b3 = (1/h(i+3))*int((z-x(i+3))^3,z,x(i+3)-h(i+3)/2,x(i+3)+h(i+3)/2);
x3b4 = (1/h(i+4))*int((z-x(i+4))^3,z,x(i+4)-h(i+4)/2,x(i+4)+h(i+4)/2);
x3bi = (1/h(i))*int((z-x(i))^3,z,x(i)-h(i)/2,x(i)+h(i)/2);
ub1 = u(i+1);
ub2 = u(i+2);
ub3 = u(i+3);
