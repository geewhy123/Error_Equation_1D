function [uu,d] = rk7(u,x,f,k,h,N,p,t,phys)
...
[upr,upl,phiVII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys);
...
[upr,upl,phiVIII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys);
...
[upr,upl,phiIX(i)] = reconflux(u,Z,f,k,h,i,N,p,phys);
