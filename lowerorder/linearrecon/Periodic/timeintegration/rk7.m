...
[upr,upl,phi(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(1)*k,gsp,Rsp);
uII(i) = u(i)+(k/6)*phi(i);
%d = max(d,abs(delt)); 
end
...
[upr,upl,phiII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(2)*k,gsp,Rsp);
...
[upr,upl,phiIII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(3)*k,gsp,Rsp);
...
[upr,upl,phiIV(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(4)*k,gsp,Rsp);
...
[upr,upl,phiV(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(5)*k,gsp,Rsp);
...
[upr,upl,phiVI(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(6)*k,gsp,Rsp);
...
[upr,upl,phiVII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(7)*k,gsp,Rsp);
...
[upr,upl,phiVIII(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(8)*k,gsp,Rsp);
...
[upr,upl,phiIX(i)] = reconflux(u,Z,f,k,h,i,N,p,phys,uder,j,time+c(9)*k,gsp,Rsp);
